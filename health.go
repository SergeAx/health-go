...
// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3
type Health struct {
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.1
	Status Status `json:"status" example:"pass"`

	// version: (optional) public version of the service
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.2
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.3
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.4
	Notes []string `json:"notes,omitempty"`

	// output: (optional) raw error output, in case of "fail" or "warn" states.
	// This field SHOULD be omitted for "pass" state.
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.5
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.6
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.7
	Links map[string]string `json:"links,omitempty"`

	// serviceId (optional) is a unique identifier of the service, in the application scope.
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.8
	ServiceID string `json:"serviceId,omitempty"`

	// description (optional) is a human-friendly description of the service.
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-3.9
...
// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4
type Checks struct {
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.1
	...
	//   URIs do not have to be dereferenceable, however.
	//   They are just a namespace, and the meaning of a namespace CAN be provided by any convenient means (e.g. publishing an RFC, Swagger document or a nicely printed book).
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.2
	ComponentType string `json:"componentType,omitempty"`

	// observedValue: (optional) could be any valid JSON value, such as: string, number, object, array or literal.
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.3
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.4
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.5
	Status Status `json:"status" example:"pass"`
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.6
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.7
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.8
	Output string `json:"output,omitempty"`
	...
	// See https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html#section-4.9
	Links map[string]string `json:"links,omitempty"`
}
...
// @Description Returns the service health according to the upcoming IETF RFC Health Check Response Format for HTTP APIs https://tools.ietf.org/id/draft-inadarei-api-health-check-06.html
